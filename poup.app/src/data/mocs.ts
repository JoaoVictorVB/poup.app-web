...
export const MOCK_SUBSCRIPTIONS: Subscription[] = [
  {
    id: 1,
    name: 'Google One',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Google_One_logo.svg/1200px-Google_One_logo.svg.png',
    category: 'Serviços em Nuvem',
    cost: 12.0,
    currency: 'EUR',
    paymentFrequency: 'Mensal',
    nextPayment: '2025-09-22',
  ...
  },
  {
    id: 3,
    name: 'iCloud',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Apple_iCloud_logo.svg/1200px-Apple_iCloud_logo.svg.png',
    category: 'Serviços em Nuvem',
    cost: 10.0,
    currency: 'EUR',
    paymentFrequency: 'Mensal',
    nextPayment: '2025-09-29',
  ...
  },
  {
    id: 6,
    name: 'Proton',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Proton_logo.svg/1200px-Proton_logo.svg.png',
    category: 'Produtividade',
    cost: 180.0,
    currency: 'EUR',
    paymentFrequency: '2 anos',
    nextPayment: '2025-12-21',
    paymentMethod: 'Cartão de Crédito',
    paidBy: 'John Doe',
    url: 'https://proton.me/',
    notes: '',
