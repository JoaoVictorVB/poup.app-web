  ...
  return (
    <div className="space-y-8">
        ...
        <form onSubmit={handleSaveProfile} className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              <strong>Nota:</strong> A funcionalidade de atualização de perfil está em
              desenvolvimento.
            </p>
          </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <button
          onClick={onLogout}
          className="bg-red-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-red-700 flex items-center space-x-2"
        >
          <LogOut size={18} />
